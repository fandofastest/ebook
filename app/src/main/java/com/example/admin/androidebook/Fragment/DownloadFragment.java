...
import static com.example.admin.androidebook.Activity.MainActivity.DIRDL;
...
public class DownloadFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        root = Environment.getExternalStorageDirectory() + DIRDL;
    ...
    private List<File> getListFiles(File parentDir) {
        ...
        files.addAll(Arrays.asList(Objects.requireNonNull(parentDir.listFiles())));
        while (!files.isEmpty()) {
